...
useEffect(() => {
    ...
    Promise.all([
        analytics.overview(start, end, aid),
        analytics.bySymbol(start, end, aid),
        analytics.heatmap({ start, end, accountId: aid }),
        analytics.byWeekday(start, end, aid),
        analytics.trades(start, end, aid),
